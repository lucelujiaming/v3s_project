...
#   user.o
#
DEPS_60 += $(CONFIG)/inc/goahead.h

$(CONFIG)/obj/user.o: \
    src/user.c $(DEPS_60)
	@echo '   [Compile] $(CONFIG)/obj/user.o'
	$(CC) -c -o $(CONFIG)/obj/user.o $(CFLAGS) $(DFLAGS) $(IFLAGS) "-I$(BIT_PACK_MATRIXSSL_PATH)" "-I$(BIT_PACK_MATRIXSSL_PATH)/matrixssl" "-I$(BIT_PACK_NANOSSL_PATH)/src" "-I$(BIT_PACK_OPENSSL_PATH)/include" src/user.c
...
$(CONFIG)/bin/goahead: $(DEPS_33)
	...
	$(CC) -o $(CONFIG)/bin/goahead $(LDFLAGS) $(LIBPATHS)    "$(CONFIG)/obj/goahead.o" "$(CONFIG)/obj/user.o" $(LIBPATHS_33) $(LIBS_33) $(LIBS_33) $(LIBS) $(LIBS) 
